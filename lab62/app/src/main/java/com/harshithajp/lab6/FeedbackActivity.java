...
public class FeedbackActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    RatingBar ratingbar;
    String[] suggestions = { "Time consuming to understand", "easy to understand", "Couldn't understand"};
    String suggestion = "";
    Switch sw ;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        ArrayAdapter ad = new ArrayAdapter(this, android.R.layout.simple_spinner_item, suggestions);
        ...
        new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Snackbar snackbar = Snackbar.make(layout, "As per your choice,"+str1+"& Thankyou for rating us "+rating+" stars! and suggesting that the quiz was "+sug, Snackbar.LENGTH_SHORT);
